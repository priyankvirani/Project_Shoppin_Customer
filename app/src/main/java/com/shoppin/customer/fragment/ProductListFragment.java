...
public class ProductListFragment extends BaseFragment {
    ...
    private ArrayList<String> getTabName() {
        ...
        for (int i = 0; i < subCategoryArrayList.size(); i++) {
            subCategoryNameArrayList.add(subCategoryArrayList.get(i).subcategoryName);
        }
    ...
    private void loadTabs() {
        ...
        for (int i = 0; i < subCategoryNameArrayList.size(); i++) {
            ...
            args.putSerializable(ProductListFragment.SUB_CATEGORY_ARRAYLIST, subCategoryArrayList);
